...
function Snorql() {
    ...
    this._endpoint = "https://dydra.com/ut-digital-archives/aozora/sparql";/*document.location.href.match(/^([^?]*)snorql\//)[1] + 'sparql';*/
    // modify these to your likeing
    this._poweredByLink = 'https://github.com/TEI-EAJ/aozora_tei';
    this._poweredByLabel = 'TEI-EAJ/aozora_tei';
